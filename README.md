# Дипломный проект профессии «1C-программист: с нуля до middle» (Алишева С.А.)
...
#### Полная постановка задачи находится [здесь](https://github.com/avgustconf-sys/fonecmid-diplom)
...
1. В режиме администратора настроить [телеграмм-бот](https://github.com/avgustconf-sys/fonecmid-diplom/blob/main/tasks/telegram.md)
